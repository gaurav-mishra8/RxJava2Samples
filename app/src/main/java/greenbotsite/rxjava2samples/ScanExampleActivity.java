...
public class ScanExampleActivity extends AppCompatActivity {
    ...
    public static void startActivity(Context context) {
        Intent intent = new Intent(context, ScanExampleActivity.class);
    ...
    public void start() {
        compositeDisposable.add(createObservable()
                .scan((str1, str2) -> str1.concat("_" + str2))
    ...
    private Observable<String> createObservable() {
        ...
        return Observable.defer(() -> //Observable.just("apple", "mango", "banana"));
                Observable.concat(Observable.just("apple", "mango", "banana"), Observable.just("potato", "cabbage", "cauliflower", "brinjal")));
    }
